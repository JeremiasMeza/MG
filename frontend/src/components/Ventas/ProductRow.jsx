      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between text-xs">
          <div className="flex items-center space-x-2">
            {product.barcode && (
              <span className="text-gray-500">Cod: {product.barcode}</span>
            )}
      ...
      <div className="flex items-center space-x-1">
        <div className="flex items-center border border-gray-300 rounded overflow-hidden">
          <button
            ...
            className="px-1 py-0.5 bg-gray-50 hover:bg-gray-100 text-gray-600 transition-colors duration-200 flex items-center justify-center"
          ...
          <input
            ...
            className="w-8 px-1 py-0.5 text-center border-0 focus:ring-0 focus:outline-none text-xs"
