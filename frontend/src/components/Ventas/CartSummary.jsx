...
function CartSummary({
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      {/* Header del carrito - altura fija - MISMO PADDING QUE PRODUCTOS */}
      ...
      {/* Contenido principal - altura flexible - MISMO PADDING QUE PRODUCTOS */}
      <div className="flex-1 p-6 pt-4 overflow-hidden flex flex-col">
        ...
        {/* Resumen de precios */}
        <div className="flex-shrink-0 border-t border-gray-200 pt-4 mb-6">
        ...
        {/* Información del cliente - área scrolleable */}
      ...
      {/* Footer con botón - altura fija - MISMO PADDING QUE PRODUCTOS */}
